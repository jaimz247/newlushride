...
export default function Experience() {
  return (
    <section id="services" className="bg-theme transition-colors duration-500 py-32">
      <Helmet>
        <title>Experience | LushRide</title>
        <meta name="description" content="Explore the Experience section of LushRide's premium chauffeur services." />
      </Helmet>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display text-white leading-tight mb-8">
              Provide luxury ride hailing and most comfortable experience
            </h2>
          ...
          >
            <p className="text-lg text-muted-2 font-light leading-relaxed mb-12">
              LushRide, based in Lagos, delivers premium ride experiences designed for comfort, convenience, and excellence. 
